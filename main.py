...
from gameResult import moveResultPage
from driverAndSql import driverSetting
from leagueInfo import leagueAndRoundInfo
    ...
    for round in rounds:
        ...
        while True:
            ...
            try:
                ...
                leagueAndRoundInfo(webAddress + '&team=&yymm=&r_round=' + round, i-1)
                print('element 없음')
                break
